...
class HeroEffect {
    ...
    async init() {
        ...
        const tex1 = await loadTexture('/v4/woman4.webp');
        const tex2 = await loadTexture('/v4/leoa.webp');
        const depthTex1 = await loadTexture('/v4/woman4_depth.webp');
        const depthTex2 = await loadTexture('/v4/leoa_depth.webp');
