...
class HeroEffect {
    ...
    async init() {
        ...
        const tex1 = await loadTexture('/v2/woman2.jpg');
        const tex2 = await loadTexture('/v2/tiger2.jpg');
        const depthTex1 = await loadTexture('/v2/woman2_depth.jpg');
        const depthTex2 = await loadTexture('/v2/tiger_depth.jpg');
